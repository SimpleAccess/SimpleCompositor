...
class SimpleAccessWM:
    ...
    def serverDrawFrame(self, listerer, data):
        ...
        for layerView in self.layerViews
            ...
            layerView.layerShell.wlr_layer_surface_v1_for_each_surface(self.renderSurface, data)
    ...
    def focusLayerView(self, layerView, surface=None):
        if surface is None:
            surface = view.layerShell.surface
        ...
        if previousSurface is not None:
            previousLayerShell = LayerShell.from_surface(previousSurface)
